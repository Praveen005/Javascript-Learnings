...
/*
//There can be situation when, click event is not propogated inside the child elements, i.e click is may get triggered by clicking the parent but may not by clicking the child elements, 
//can be dealt both ways, above & below one
